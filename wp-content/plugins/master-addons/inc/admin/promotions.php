    ...
    class Master_Addons_Promotions
    {
        ...
        public function jltma_latest_update_details()
        {
            ...
            $jltma_changelog_message = sprintf(
                 ...
                 * Starts from: %3$s
                 */
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">"Timeline" addon -  Date displaying twice on responsive mode fixed</span><br>', 'master-addons'), //%3$s
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">"Infobox" addon -  default hover style visiblity issue fixed, removed duplicate settings and code cleaned up</span><br>', 'master-addons'),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">"Navigation Menu" addon -  Style issue fixed when Layout/Type is VERTICSL/SIDE. </span><br>', 'master-addons'),
        ...
        <?php
                    ...
                    public function jltma_admin_black_friday_cyber_monday_notice($notice_key)
                    {
                        ...
                        echo /* translators: 1: Info 2: Discount 3: Coupon */ sprintf(
                            ...
                            __('25% Discounts for <span style="background:#111; padding:2px 10px; color: #fff;">Black Friday and Cyber Monday Deals</span><br>', 'master-addons'),
                            __("Coupon Code: <strong style='background:yellow; padding:2px 10px; color: #0347FF;'>BFCM25</strong>", "master-addons")
                        );
